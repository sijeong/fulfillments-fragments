...
const search_url = 'https://cloudhospitalsearch.search.windows.net/indexes/idx-hospitals-prd/docs?api-version=2020-06-30&search=';
...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest(
  (request, response) => {
    ...
    intentMap.set('intro', handleSelection);
...
function createCalendarEvent(dateTimeStart, dateTimeEnd, appointment_type) {
  ...
  function searchHospitals(searchKeyword){
    const request = require('request');
    request.get(search_url + searchKeyword, (error, response, body) => {
      if(error){
  ...
  function searchHospitalsBySpecialty(){
    const options = {
...
// https://cloudhospitalsearch.search.windows.net/indexes/idx-hospitals-prd/docs?api-version=2020-06-30&search=cancer + korea